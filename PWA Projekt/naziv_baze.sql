...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1053993213ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="230">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=naziv_baze&table=korisnik">`naziv_baze`.`korisnik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=naziv_baze&table=vijesti">`naziv_baze`.`vijesti`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=naziv_baze&table=Korisnik">`naziv_baze`.`Korisnik`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=naziv_baze&table=naziv_tablice">`naziv_baze`.`naziv_tablice`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test2&table=student">`test2`.`student`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test2&table=users">`test2`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="58685e67633a69602e7539555e6f2664">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="230"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="naziv_baze" targettable="vijesti">
            ...
            Queried time
                            ...
                            targetdb="naziv_baze" targettable="korisnik">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `naziv_baze`.`korisnik` ( `id` INT(11) NULL ,  `ime` VARCHAR(32) CHARACTER SET utf8 COLLATE utf8_croatian_ci NOT NULL ,  `prezime` VARCHAR(32) CHARACTER SET utf8 COLLATE utf8_croatian_ci NOT NULL ,  `korisnicko_ime` VARCHAR(32) CHARACTER SET utf8 COLLATE utf8_croatian_ci NOT NULL ,  `lozinka` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_croatian_ci NOT NULL ,  `razina` TINYINT(1) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="naziv_baze" targettable="korisnik">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `korisnik` ADD UNIQUE(`korisnicko_ime`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="naziv_baze" targettable="vijesti">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `korisnik` ADD PRIMARY KEY(`id`);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="naziv_baze" targettable="korisnik">
                            <div class="action_content">
